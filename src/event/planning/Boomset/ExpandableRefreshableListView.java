...
public class ExpandableRefreshableListView  extends ExpandableListView {
    ...
    public ExpandableRefreshableListView(final Context context) {
        super(context);
        initialize();
        
    }

    public ExpandableRefreshableListView(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        initialize();
    }

    public ExpandableRefreshableListView(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public void completeRefreshing(String timeStamp) {
        mProgress.setVisibility(View.INVISIBLE);
        mArrow.setVisibility(View.VISIBLE);
        if (timeStamp != null) {
        	try {
				String refreshTimeStamp = URLDecoder.decode(timeStamp, "UTF-8");
				timeStampView.setText("Last Updated: " + refreshTimeStamp);
    ...
    private void initialize() {
        ...
        timeStampView = (TextView) mHeaderContainer.findViewById(R.id.lastUpdatedText);
    ...
    public interface OnRefreshListener {
        public void onRefresh(ExpandableRefreshableListView listView);
    }
